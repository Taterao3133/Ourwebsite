...
function TermsandConditions() {
  return (
    ...
    <div className="lg:border-[1px] lg:border-[#000000] w-full max-sm:h-auto h-[600px] mt-10 max-sm:px-2 px-10"> 
       ...
       <p className='text-[#4F5D81] text-lg  max-sm:text-base font-roboto-serif mt-3'>For any questions or concerns regarding payment terms and conditions, please contact our support team at support@Webvtx.com.</p>
       <hr className='border-[1px] w-full border-[#000000] mt-3'/>
