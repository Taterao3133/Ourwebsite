    ...
    <div className="cust_app">
      <div className="about-sec  max-sm:h-auto lg:h-[620px] md:h-auto max-sm:justify-center max-sm:items-center w-full  lg:px-8 xl:px-20 bg-gradient-to-b from-[#FFFFFF] to-[#e3fbd4]">
        <div className="lg:grid-cols-2 lg:pb-5 lg:grid pt-20 md:mx-auto  max-sm:mx-4 lg:space-x-32">
          <div className="lf_cnt font-roboto-serif md:px-7 max-lg:text-center">
            <h2 className="font-medium max-sm:text-xl lg:text-[40px] md:text-4xl text-[#484DA9]">Elevate Your Business with Custom App Development by XXXXX</h2>
            <p className="font-medium lg:text-lg md:text-base max-sm:text-base max-md:px-9  text-[#0C3461] mt-4">XXXXX inventory management apps are here to transform the way you manage and track your inventory. 
          ...
          <div className="rt_cnt md:mt-10 md:pb-8">
            <img src={customapp} alt="" className='lg:h- md:h-auto md:w-3/6 md:mx-auto' />
          </div>
        </div>
      ...
      <div className="client_page text-center lg:w-3/6 xl:w-2/6 lg:mx-auto pb-[80px]">
        <h2 className='font-roboto-serif font-medium text-[40px] md:text-4xl max-sm:text-xl text-[#E13535] pt-[80px]'>Clients Trust XXXXX for Their App Development Needs</h2>
      ...
      <div className="future bg-[#F2E4E066] h-auto w-full pt-10 xl:px-20 pb-7">
        ...
        <p className='font-roboto-serif font-normal text-[#5955A1] xl:pt-5 md:text-base max-sm:text-base md:mt-5 lg:text-lg text-center xl:px-64'>"XXXXX excels in creating innovative 
      ...
      <div className="about-sec  max-sm:h-auto lg:h-[620px] max-sm:justify-center max-sm:items-center w-full  lg:px-8 xl:px-20 bg-gradient-to-b from-[#B7D9F9CC] to-[#B7D9F9CC]">
        <div className="lg:grid-cols-2 lg:pb-5 lg:grid pt-20 md:mx-auto  max-sm:mx-4">
          <div className="lf_cnt">
            <img src={customapp} alt="" className='lg:h-' />
          </div>
          <div className="rt_cnt font-roboto-serif">
            <h2 className="font-medium text-[40px] text-[#484DA9]">Experience the Difference: Custom App Development with XXXXX</h2>
            <p className="font-medium lg:text-lg text-[#0C3461] mt-4">Our journey in app development has been marked by a dedication 
