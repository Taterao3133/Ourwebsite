...
const slides = [
  {
    ...
    image: portfolio1,
    progression: [true, false, false], // Example progression for this slide
  },
  {
    ...
    image: portfolio2,
    progression: [false, true, false], // Example progression for this slide
  },
  {
    ...
    image: portfolio3,
    progression: [false, false, true], // Example progression for this slide
  },
];
        ...
        <div className="relavite w-[90%]">
          ...
          <div className="flex transition-transform duration-1000" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
            {slides.map((slide, index) => (
                ...
                <div className="l-c">
                  <h2 className="text-[40px] max-sm:hidden text-[#AE7C36] font-roboto-serif font-medium mt-16 text-center">
                    {slide.title}
                  </h2>
                  <p className="text-xl max-sm:hidden text-[#302F68] font-roboto-serif mt-10 pl-11">
                    {slide.description}
                  </p>
                  </div>
                <div className="r-c lg:mt-16">
