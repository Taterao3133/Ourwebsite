...
function Footer() {
  return (
    <div className='foot w-full h-auto overflow-hidden bg-[#141064] pb-5'>
      <div className=" grid md:grid-cols-2 md:mx-10 lg:grid-cols-3 md:space-x-32 pb-5 pt-16 max-sm:mx-4 lg:px-20" >
        ...
        <div className="gr w-full max-sm:mt-8 h-auto">
          ...
          <div className="lnks max-sm:space-y-2 lg:space-y-5 max-sm:mt-2 lg:mt-7">
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'>Custom App Development</p>
            
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'>Android App Development</p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'>E-Commerce Website</p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'>Landing Pages</p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'>Visual Design Services</p>
          </div>
        </div>
        <div className="gr w-full max-sm:mt-7 h-auto">
          ...
          <div className="lnks max-sm:space-y-2 lg:space-y-5 max-sm:mt-2 md:mt-7">
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'><Link to='/about'>About Us</Link></p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'><Link to='/contactus'>Contact Us</Link></p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'><Link to='/career'>Careers</Link></p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'><Link to='/privacypolicy' >Refund Policy</Link></p>
            <p className='text-[#D9D9D9CC] text-lg max-sm:text-base font-roboto-serif'><Link to='/termsandcondition'>Terms and Conditions</Link></p>
          </div>
        </div>
